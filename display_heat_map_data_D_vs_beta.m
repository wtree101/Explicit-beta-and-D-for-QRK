...
filename_heat_map = sprintf('\\heat_map_data\\D_vs_beta%s',filename);
filename_D_min_vals = sprintf('\\heat_map_data\\D_vs_beta__D_min%s',filename);
filename_D_samples = sprintf('\\heat_map_data\\D_vs_beta__D_samples%s',filename);
filename_beta_samples = sprintf('\\heat_map_data\\D_vs_beta__beta_samples%s',filename);
...
figure
imagesc('XData', beta_samples, 'YData', D_samples, 'CData', A)
colormap("jet")
hold on 
